...
import qualified Benchmark.Impulse as Impulse
...
main = defaultMain
    ...
    [ bgroup "benchmark1/100-nodes-100-steps"
          ...
          , bench "impulse" $ whnfIO $ Impulse.benchmark1 100 100
    ...
    , bgroup "benchmark1/100-nodes-1000-steps"
          ...
          , bench "banana" $ whnfIO $ Banana.benchmark1 100 1000
          , bench "impulse" $ whnfIO $ Impulse.benchmark1 100 1000
    ...
    , bgroup "benchmark1/1000-nodes-100-steps"
          ...
          , bench "impulse" $ whnfIO $ Impulse.benchmark1 1000 100
    ...
    , bgroup "benchmark1/1000-nodes-1000-steps"
          ...
          , bench "impulse"  $ whnfIO $ Impulse.benchmark1  1000 1000
    ...
    , bgroup "benchmark1/1000-nodes-10000-steps"
          ...
          , bench "impulse" $ whnfIO $ Impulse.benchmark1 1000 10000
    ...
    , bgroup "benchmark1/10000-nodes-100-steps"
          ...
          , bench "impulse" $ whnfIO $ Impulse.benchmark1 10000 100
    ...
    , bgroup "benchmark1/10000-nodes-1000-steps"
          ...
          , bench "impulse" $ whnfIO $ Impulse.benchmark1 10000 1000
    ...
    , bgroup "benchmark2/100-nodes-100-steps"
          ...
          , bench "impulse" $ whnfIO $ Impulse.benchmark2 100 100
          ]
    , bgroup "benchmark2/100-nodes-1000-steps"
          ...
          , bench "impulse" $ whnfIO $ Impulse.benchmark2 100 1000
          ]
    , bgroup "benchmark2/1000-nodes-100-steps"
          ...
          , bench "impulse" $ whnfIO $ Impulse.benchmark2 1000 100
          ]
    , bgroup "benchmark2/1000-nodes-1000-steps"
          ...
          , bench "impulse" $ whnfIO $ Impulse.benchmark2 1000 1000
          ]
    , bgroup "benchmark2/1000-nodes-10000-steps"
          ...
          , bench "impulse" $ whnfIO $ Impulse.benchmark2 1000 10000
          ]
    , bgroup "benchmark2/10000-nodes-100-steps"
          ...
          , bench "impulse" $ whnfIO $ Impulse.benchmark2 10000 100
          ]
    , bgroup "benchmark2/10000-nodes-1000-steps"
          ...
          , bench "impulse" $ whnfIO $ Impulse.benchmark2 10000 1000
          ]
    , bgroup "benchmark2/100000-nodes-100-steps"
          ...
          , bench "impulse" $ whnfIO $ Impulse.benchmark2 100000 100
          ]
    ]
